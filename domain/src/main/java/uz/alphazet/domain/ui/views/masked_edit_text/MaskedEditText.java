package uz.alphazet.domain.ui.views.masked_edit_text;
...
//					return false;
    ...
    public MaskedEditText(Context context, AttributeSet attrs) {
        ...
        TypedArray attributes = context.obtainStyledAttributes(attrs, R.styleable.SecondMaskedEditText);
        mask = attributes.getString(R.styleable.SecondMaskedEditText_second_mask);

        allowedChars = attributes.getString(R.styleable.SecondMaskedEditText_allowed_chars);
        deniedChars = attributes.getString(R.styleable.SecondMaskedEditText_denied_chars);
        boolean enableImeAction = attributes.getBoolean(R.styleable.SecondMaskedEditText_enable_ime_action, false);

        String representation = attributes.getString(R.styleable.SecondMaskedEditText_char_representation);
        ...
        keepHint = attributes.getBoolean(R.styleable.SecondMaskedEditText_keep_hint, false);
